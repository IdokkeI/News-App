...
namespace news_server.Migrations
{
    ...
    [Migration("20201001085828_updStatisticNews")]
    partial class updStatisticNews
    {
            ...
            modelBuilder.Entity("news_server.Data.dbModels.User", b =>
                {
                    ...
                    b.Property<int?>("StatisticNewsId2")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("news_server.Data.dbModels.User", b =>
                {
                    ...
                    b.HasOne("news_server.Data.dbModels.StatisticNews", null)
                        .WithMany("Views")
                        .HasForeignKey("StatisticNewsId2");
                });
